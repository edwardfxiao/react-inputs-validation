...
import { Textbox, Textarea, Radiobox, Checkbox, Select } from '../src/js/Inputs/index';
...
const Index: React.FC<Props> = memo(({}) => {
  ...
  const [nameRg, setnameRg] = useState('');
  ...
  const [hasJobError, sethasJobError] = useState(true);
  const [hasAgreementError, sethasAgreementError] = useState(true);
  ...
  const validateForm = useCallback(
    ...
    [hasNameError, hasDescriptionError, hasMovieError, hasJobError, hasAgreementError],
  );
    ...
    <div className={CSS['wrapper']}>
        ...
        <div>
          ...
          <div style={{ overflow: 'auto', padding: '2%' }}>
            <div className={CSS['block']}>
              ...
              <div>
                <pre>
                  <code className="language-javascript">{markdownTextboxEmptyExample}</code>
                </pre>
              </div>
            </div>
          </div>
          ...
          <div style={{ overflow: 'auto', padding: '2%' }}>
            <div className={CSS['block']}>
              ...
              <div>
                <pre>
                  <code className="language-javascript">{markdownTextboxRegexExample}</code>
                </pre>
              </div>
            </div>
          </div>
          ...
          <div style={{ overflow: 'auto', padding: '2%' }}>
            <div className={CSS['block']}>
              ...
              <div>
                <pre>
                  <code className="language-javascript">{markdownTextboxNumberExample}</code>
                </pre>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <div style={{ overflow: 'auto', padding: '2%' }}>
            <div className={CSS['block']}>
              ...
              <div>
                <pre>
                  <code className="language-javascript">{markdownRadioboxEmptyExample}</code>
                </pre>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <div style={{ overflow: 'auto', padding: '2%' }}>
            <div className={CSS['block']}>
              ...
              <div>
                <pre>
                  <code className="language-javascript">{markdownCheckboxEmptyExample}</code>
                </pre>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <div style={{ overflow: 'auto', padding: '2%' }}>
            <div className={CSS['block']}>
              ...
              <div>
                <pre>
                  <code className="language-javascript">{markdownSelectEmptyExample}</code>
                </pre>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <div style={{ overflow: 'auto', padding: '2%' }}>
            <div className={CSS['block']}>
              ...
              <div>
                <pre>
                  <code className="language-javascript">{markdownTextareaEmptyExample}</code>
                </pre>
              </div>
            </div>
          </div>
      ...
      <div style={{ minHeight: '1000px', padding: '10px', border: '1px solid #e5e5e5' }}>
        ...
        <form onSubmit={e => validateForm(e)}>
          ...
          <div
            className={`${CSS['my-button']} ${CSS['my-button__red']} ${CSS['save-button']}`}
            onClick={e => {
              validateForm(e);
            }}
          >
