...
exports.isValidValue = exports.getItem = exports.getIndex = exports["default"] = exports.Option = void 0;
...
var component = function component(_ref) {
  var _ref$attributesWrappe = _ref.attributesWrapper,
      ...
      _ref$classNameOptionL2 = _ref.classNameOptionListWrapper,
      classNameOptionListWrapper = _ref$classNameOptionL2 === void 0 ? '' : _ref$classNameOptionL2,
      _ref$classNameOptionL3 = _ref.classNameOptionListContainer,
      classNameOptionListContainer = _ref$classNameOptionL3 === void 0 ? '' : _ref$classNameOptionL3,
  ...
  var selectOptionListWrapperClass = "".concat(classNameOptionListWrapper, " ").concat(reactInputsValidationCss["".concat(TYPE, "__options-wrapper")], " ").concat(err && reactInputsValidationCss['error'], " ").concat(show && reactInputsValidationCss['show'], " ").concat(successMsg !== '' && !err && reactInputsValidationCss['success'], " ").concat(disabled && reactInputsValidationCss['disabled']);
  ...
  }, item ? React.createElement("span", null, item.icon && React.createElement("img", {
    src: item.icon,
    className: reactInputsValidationCss["".concat(TYPE, "__optionItem_current_display_icon")]
  }), React.createElement("span", {
    className: reactInputsValidationCss["".concat(TYPE, "__optionItem_current_display_name")]
  ...
  return React.createElement("button", _extends({
    ...
    className: selectOptionListWrapperClass
    ...
    ref: $itemsWrapper,
    className: classNameOptionListContainer,
...
var Option = memo(function (_ref2) {
  ...
  return React.createElement("a", {
    ...
    src: item.icon,
    className: reactInputsValidationCss["".concat(TYPE, "__optionItem_icon")]
  }), React.createElement("span", {
    className: reactInputsValidationCss["".concat(TYPE, "__optionItem_name")]
  }, item.name));
});
