...
function (_React$Component) {
  ...
  _createClass(Index, [{
    ...
    value: function addActive() {
      ...
      node.current.className += " ".concat(STYLES['select__hover-active']);
    }
  }, {
    key: "removeActive",
    value: function removeActive() {
      ...
      for (var i = 0; i < x.length; i += 1) {
        ...
        node.current.className = node.current.className.replace(STYLES['select__hover-active'], '');
      }
    }
  }, {
    key: "pageClick",
    ...
    value: function render() {
      ...
      var wrapperClass = (0, _classnames.default)(classNameWrapper, STYLES['select__wrapper'], err && STYLES['error'], successMsg && !err && STYLES['success'], disabled && STYLES['disabled']);
      var containerClass = (0, _classnames.default)(classNameContainer, STYLES['select__container'], err && STYLES['error'], show && STYLES['show'], successMsg && !err && STYLES['success'], disabled && STYLES['disabled']);
      var inputClass = (0, _classnames.default)(STYLES['select__input'], err && STYLES['error'], successMsg && !err && STYLES['success'], disabled && STYLES['disabled']);
      var selectClass = (0, _classnames.default)(classNameSelect, STYLES['ellipsis'], err && STYLES['error'], successMsg && !err && STYLES['success'], disabled && STYLES['disabled']);
      var selectOptionListContainerClass = (0, _classnames.default)(classNameOptionListContainer, STYLES['select__options-container'], err && STYLES['error'], show && STYLES['show'], successMsg && !err && STYLES['success'], disabled && STYLES['disabled']);
      var selectOptionListItemClass = (0, _classnames.default)(!isTyping && STYLES['select__options-item-show-cursor'], classNameOptionListItem, STYLES['select__options-item'], err && STYLES['error'], successMsg && !err && STYLES['success'], disabled && STYLES['disabled']);
      var dropdownIconClass = (0, _classnames.default)(classNameDropdownIconOptionListItem, STYLES['select__dropdown-icon']);
