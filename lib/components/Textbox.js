...
function (_React$Component) {
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var wrapperClass = (0, _classnames.default)(classNameWrapper, STYLES['textbox__wrapper'], err && STYLES['error'], successmsg && !err && STYLES['success'], disabled && STYLES['disabled']);
      var containerClass = (0, _classnames.default)(classNameContainer, STYLES['textbox__container'], err && STYLES['error'], successmsg && !err && STYLES['success'], disabled && STYLES['disabled']);
      var inputClass = (0, _classnames.default)(classNameInput, STYLES['textbox__input'], err && STYLES['error'], successmsg && !err && STYLES['success'], disabled && STYLES['disabled']);
